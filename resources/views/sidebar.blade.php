...
<head>
    ...
    <!-- FINAL CSS -->
    <link rel="stylesheet" href="{{ asset('assets/css/bootstrap-5-css/bootstrap.min.css') }}">
    <link rel="stylesheet" href="{{ asset('assets/css/bootstrap.min.css') }}">
    <link rel="stylesheet" href="{{ asset('assets/styles.css') }}">
    <link rel="stylesheet" href="{{ asset('assets/css/boxicons/css/boxicons.min.css') }}">
    <link rel="stylesheet" href="{{ asset('assets/css/jquery.dataTables.min.css') }}">
    <link rel="stylesheet" href="{{ asset('assets/css/buttons.dataTables.min.css') }}">
    <link rel="stylesheet" href="{{ asset('assets/css/toastr.min.css') }}">
    <!-- <link rel="stylesheet" href="{{ asset('assets/css/content/dashboard.css') }}"> -->

    <!-- FINAL JS -->
    <script src="{{ asset('assets/js/dependencies-js/jquery-3.7.0.js') }}"></script>
    <script src="{{ asset('assets/js/dependencies-js/jquery.dataTables.min.js') }}"></script>
    <script src="{{ asset('assets/js/dependencies-js/dataTables.buttons.min.js') }}"></script>
    <script src="{{ asset('assets/js/dependencies-js/jszip.min.js') }}"></script>
    <script src="{{ asset('assets/js/dependencies-js/pdfmake.min.js') }}"></script>
    <script src="{{ asset('assets/js/dependencies-js/vfs_fonts.js') }}"></script>
    <script src="{{ asset('assets/js/dependencies-js/buttons.html5.min.js') }}"></script>
    <script src="{{ asset('assets/js/dependencies-js/buttons.print.min.js') }}"></script>

    <script src="{{ asset('assets/js/dependencies-js/bootstrap.min.js') }}"></script>
    <script src="{{ asset('assets/js/dependencies-js/jquery.min.js') }}"></script>
    <script src="{{ asset('assets/js/dependencies-js/popper.min.js') }}"></script>
    <script src="{{ asset('assets/js/dependencies-js/bootstrap-5-js/bootstrap.min.js') }}"></script>
    <script src="{{ asset('assets/js/dependencies-js/chart.umd.min.js') }}"></script>
    <script src="{{ asset('assets/js/dependencies-js/iconify.min.js') }}"></script>
    <script src="{{ asset('assets/js/dependencies-js/toastr.min.js') }}"></script>
